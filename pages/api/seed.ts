...
//   //   ],
//   // });
//   const seatFormat = [4, 4, 2];
//   const restaurantSeatsData = [
//     { restaurantName: 'Vivaan - fine Indian', seats: seatFormat },
//     { restaurantName: 'RamaKrishna Indian', seats: seatFormat },
//     { restaurantName: 'Coconut Lagoon', seats: seatFormat },
//     { restaurantName: 'Last Train to Delhi', seats: seatFormat },
//     { restaurantName: 'Adrak Yorkville', seats: seatFormat },
//     { restaurantName: 'Curryish Tavern', seats: seatFormat },
//     { restaurantName: 'Utsav', seats: seatFormat },
//     { restaurantName: 'Pukka', seats: seatFormat },
//     { restaurantName: 'Kamasutra Indian', seats: seatFormat },
//     { restaurantName: 'Eldorado Taco', seats: seatFormat },
//     { restaurantName: 'La Bartola', seats: seatFormat },
//     { restaurantName: 'El Catrin', seats: seatFormat },
//     { restaurantName: '3 Mariachis', seats: seatFormat },
//     { restaurantName: 'Cano Restaurant', seats: seatFormat },
//     { restaurantName: 'Blu Ristorante', seats: seatFormat },
//     { restaurantName: 'Stelvio', seats: seatFormat },
//     { restaurantName: 'Sofia', seats: seatFormat },
//   ];

//   const restaurants = await prisma.restaurant.findMany();

//   const findRestaurantId = (restaurantName: string) =>
//     restaurants.find((restaurant) => restaurant.name === restaurantName)?.id || 1;

//   for (const data of restaurantSeatsData) {
//     const restaurantId = findRestaurantId(data.restaurantName);

//     const seatsData = data.seats.map((seatCount) => ({
//       restaurant_id: restaurantId,
//       seats: seatCount,
//     }));

//     await prisma.table.createMany({ data: seatsData });
//   }
